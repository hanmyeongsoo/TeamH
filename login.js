...
app.get('/default/:file', function(request, response) {
	if (request.session.loggedin) {
		response.sendFile(path.join(__dirname + '/default/home-logout.html'));
	} else {
		response.send('Please login to view this page!');
		response.end();
	}
...
app.get('/default/:file', restrict, function(request, response) {
	if (request.session.loggedin) {
		response.sendFile(path.join(__dirname + '/default/:default.html'));
	} else {
		response.send('Please login to view this page!');
		response.end();
	}
